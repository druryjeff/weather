...
function drawWeather( d ) {
  ...
  // current day
  $('.temp').html(convertTemp(d.current.temp) + '<span>&deg;</span>');
  $('.description').html(printGraphic(d.current.weather[0].description));
  ...
  // print a class on the body based on the current weather description
